...
export const US_FUNDAMENTAL_EXPLAINERS: ExplainerItem[] = [
  ...
  },
  {
    ...
    range: {
      ...
      unit: 'x',
      bands: [
        { to: 0.3, label: 'Conservative', marks: 8 },
        { to: 0.8, label: 'Manageable', marks: 5 },
        { to: 1.5, label: 'Elevated', marks: 2 },
        { to: 2.5, label: 'High', marks: 0 },
      ],
      example: 0.6,
    },
  },
  ...
  },
  {
    ...
    range: {
      ...
      unit: '',
      bands: [
        { to: 30, label: 'Reasonable', marks: 6 },
        { to: 45, label: 'Elevated', marks: 3 },
        { to: 70, label: 'Rich', marks: 0.5 },
      ],
      example: 28,
    },
  },
  {
    ...
    range: {
      ...
      unit: '',
      bands: [
        { to: 3.6, label: 'Cheap', marks: 4 },
        { to: 6, label: 'Reasonable', marks: 2 },
        { to: 9, label: 'Rich', marks: 0.5 },
      ],
      example: 3,
    },
  },
...
export const US_TECHNICAL_EXPLAINERS: ExplainerItem[] = [
  ...
  },
  {
    ...
    range: {
      ...
      unit: 'x',
      bands: [
        { to: 0.8, label: 'Weak', marks: 1 },
        { to: 1.5, label: 'Acceptable', marks: 3.5 },
        { to: 3, label: 'Strong', marks: 5 },
      ],
      example: 1.0,
    },
  },
